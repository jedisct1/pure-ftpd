#define MSG_TLS_CIPHER_FAILED "SSL/TLS: Fehlerhafte TLSCipherSuite definiert '%s'"
...
#define MSG_ONLY_IPV4V6 "Es werden nur IPv4 und IPv6 unterstätzt (1,2)."
...
#define MSG_GOODBYE "Tschüs. Verbindungen: Upload %llu und Download %llu kbytes."
...
#define MSG_NO_DISK_SPACE "Festplatte voll - bitte spüter hochladen."
