...
export CFLAGS="-pthread -Oz -arch armv5 -arch armv6 -arch armv7"
export LDFLAGS="-pthread -L$TARGET_PATH/usr/lib -arch armv5 -arch armv6 -arch armv7"
...
export CFLAGS="-pthread -Os -arch i386 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5"
export LDFLAGS="-pthread -arch i386 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5"
...
(
export CPPFLAGS="-D__IPHONE__=1 -DNO_PROCNAME_CHANGE -DANON_CAN_CHANGE_PERMS=1 -DANON_CAN_CHANGE_UTIME=1 -DANON_CAN_DELETE=1 -DANON_CAN_RESUME=1 -DANON_CAN_RENAME=1"
export CFLAGS="-pthread -Os -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5"
export LDFLAGS="-pthread -arch x86_64 -isysroot /Developer/SDKs/MacOSX10.5.sdk -mmacosx-version-min=10.5"
